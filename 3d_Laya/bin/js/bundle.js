(function () {
    ...
    class SeparableSSS_RenderDemo extends SingletonScene {
        ...
        createCommandBuffer(camera, character) {
            ...
            buf.setShaderDataVector2(this.sssssBlitMaterail.shaderData, this.sssssBlitMaterail.SHADERVALUE_BLURDIR, new Vector2$1(10.0, 0.0));
            buf.blitScreenQuadByMaterial(diffuseRenderTexture, blurRenderTexture, new Vector4$b(0, 0, 1.0, 1.0), this.sssssBlitMaterail, 0);
            buf.setShaderDataVector2(this.sssssBlitMaterail.shaderData, this.sssssBlitMaterail.SHADERVALUE_BLURDIR, new Vector2$1(0.0, 10.0));
