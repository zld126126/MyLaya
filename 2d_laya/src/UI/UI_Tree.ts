...
export class UI_Tree extends SingletonScene {
    constructor() {
        super();
...
class Item extends Box {
    constructor() {
        ...
        var selectBox: Clip = new Clip(GlobalConfig.ResPath + "res/ui/tree/clip_selectBox.png", 1, 2);
        ...
        var folder: Clip = new Clip(GlobalConfig.ResPath + "res/ui/tree/clip_tree_folder.png", 1, 3);
        ...
        var arrow: Clip = new Clip(GlobalConfig.ResPath + "res/ui/tree/clip_tree_arrow.png", 1, 2);
