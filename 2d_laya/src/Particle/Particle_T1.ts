...
export class Particle_T1 extends SingletonScene {
    private sp: Particle2D;

    constructor() {
        super();
        Laya.stage.addChild(this);
        Laya.loader.load(GlobalConfig.ResPath + "res/particles/GravityMode.part", Handler.create(this, this.onAssetsLoaded), null, Loader.JSON);
    }
